...
$sql="update tblperson set Category=:cat,Name=:name,MobileNumber=:mobilenumber,Address=:address,City=:city,Pasword=:Pasword where ID=:eid";
...
<head>
  ...
  <title>Service Provider | Update Person Detail</title>
...
<option value="<?php echo htmlentities($row1->Category);?>"><?php echo htmlentities($row1->Category);?></option>
 <?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Pasword" name="Pasword" value="<?php echo htmlentities($row->Pasword);?>" required="true">
                  </div> 
                </div>
              <?php $cnt=$cnt+1;}} ?> 
