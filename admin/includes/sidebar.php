 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link" style="font-weight:bold; font-size:22px;">
      ...
      <span class="brand-text font-weight-light">Service Provider Admin</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/mush.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
<?php
...
{               ?>
          <a href="admin-profile.php" class="d-block">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome :<br> <?php  echo $row->AdminName;?></a>
          <?php $cnt=$cnt+1;}} ?>
        </div>
      </div>
